...
exports.default = function (config) {
    return function (options) { return __awaiter(_this, void 0, void 0, function () {
        var user, _a, _b, _c, err_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 3, , 4]);
                    _b = (_a = config.models.User).create;
                    _c = {
                    ...
                    return [4 /*yield*/, hashPassword_1.default(options.password)];
                ...
                case 3:
                    err_1 = _d.sent();
                    if (err_1 instanceof sequelize_1.UniqueConstraintError) {
