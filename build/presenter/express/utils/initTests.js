...
var createSupertest = require("supertest");
...
var presenterFacade = index_1.default({
...
var request = createSupertest(app);
exports.default = function () {
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.migrate()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.rollback()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, service.migrate()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
